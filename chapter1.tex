...
\section{Outflows from NSBH Mergers}\label{sec:nsbh}
    ...
    The major difference in the NSBH merger pathway to SGRBs, compared to the case of
    ...
    These conclusions can be reached from Fig. \ref{fig:nsbh_disruption_condition} as
    ...
    Using this one can define the structure of the SGRB jet, given by the following
    equations:
