...
\section{Analysis of Population Synthesis Models}
    ...
    INTEGRAL satellite has a lower fluence cut-off of $2 \times 10^{-7}$ erg, and so with
...
\section{Event Analysis}\label{sec:event_analysis}
    ...
    \subsection{GW190426\_152155}\label{ssec:nsbh_190426}
        ...
        \begin{figure}[H]
            \centering
            \includegraphics[width=\linewidth]{fluence_190426}
            \caption[Fluence distribution for GW190426, from LSC Posteriors]
            {
                ...
                by the LSC for GW190426, using \ref{eq:fluence}.
            }
        ...
        was observed by INTEGRAL around the time of merger. So overall, operating under
        the assumption that the \emph{NSBH} event GW190426 launched a SGRB jet, roughly
        $~ 30$\% (= 1344/4796) agree with the observations.  This means correspondingly
    ...
    \subsection{GW190425}\label{ssec:nsbh_190425}
        ...
        INTEGRAL at the time of the merger (which is $(1.6 \pm 0.4) \times 10^{-7}$
