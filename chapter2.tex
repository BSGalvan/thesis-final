        ...
        \begin{itemize}
            ...
            \item Uniform spin distribution: here $\chi_{BH} \sim \mathcal{U}(0, 1)$.
                ...
                \begin{figure}[H]
                    ...
                    \input{figures/unif_dist.pdf_tex}
            ...
            \item Gaussian spin distributions: here $\chi_{BH} \sim \mathcal{N}(\mu,
                ...
                \begin{figure}[H]
                    \centering
                    \def\svgwidth{0.8\linewidth}
                    \input{figures/gauss_dists.pdf_tex}
...
\section{Validation of Population Synthesis Code}\label{sec:popsyn_validation}
    ...
    \subsection{GW Checks}\label{sub:gw_checks}
        ...
        \begin{figure}[H]
            \centering
            \def\svgwidth{0.8\linewidth}
            \input{figures/rho_dist.pdf_tex}
        ...
        \begin{figure}[htpb]
            ...
            \input{figures/iota_dl_colorcoded.pdf_tex}
    ...
    \begin{figure}[H]
        ...
        \input{figures/number_fluence.pdf_tex}
    ...
    \begin{figure}[H]
        \centering
        \def\svgwidth{0.8\linewidth}
        \input{figures/fluence_thetav+spin(3).pdf_tex}
        \caption
        [
    ...
    \begin{figure}[H]
        \centering
        \def\svgwidth{0.8\linewidth}
        \input{figures/fluence_thetav+spin(5).pdf_tex}
        \caption
        [
    ...
    \begin{figure}[ht]
        \centering
        \def\svgwidth{0.8\linewidth}
        \input{figures/fluence_thetav+spin(10).pdf_tex}
        \caption
        [
