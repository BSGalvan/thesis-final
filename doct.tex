...
\begin{document}
    ...
    %\makelistofalgorithms % List of algorithms -- TODO (justify need)
    \makeabbreviations % List of abbreviations -- TODO (in progress)
    %\makenomenclature % Nomenclature (for symbols used) -- TODO (justify need)
